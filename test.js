...
var menuItemType,
    ...
    moConfig = { attributes: !0, childList: !0, subtree: !0, characterDataOldValue: !0, attributeOldValue: !0 },
    moTarget = document,
    slidingMenu = true;
if (slidingMenu) {
...
function moCallback(e, t) {
    ...
    (header = document.querySelector("header[data-booted='true']")),
        ...
        (btnToTopVisible = !1),
        btnToTop && ((btnToTopVisible = !0), (btnToTop = btnToTop.closest("button")), pinMenu || "5px" == btnToTop.style.left || (btnToTop.style.left = "5px")),
        header && !headerProcessed && (customizeHeader(header), (headerProcessed = !0)),
        navigation && !navProcessed && (customizeNavigation(navigation), (navProcessed = !0)),
        main && !mainProcessed && (customizeMainContent(main), (mainProcessed = !0)),
        footer && !footerProcessed && (customizeFooter(footer), (footerProcessed = !0)),
            ...
            : (t.forEach(function (e) {
                  ...
                  if ("DVD" == (menuItemType = getMenuItemType(e)) && hideDivider) e.style.display = "none";
                      ...
                      n.wrapGroup(CM_SECTION),
                          t.classList.add(CM_COLLAPSIBLE, CM_COLLAPSIBLE_INACTIVE),
                          sectionContainsActivePage(n)
                              ? t.classList.toggle(CM_COLLAPSIBLE_INACTIVE)
              ...
              t.forEach(function (e) {
                  "HDR" == (menuItemType = getMenuItemType(e))
                      ? (getMenuItemInfo(e, "icon") && (headerAppendIcon(e, getMenuItemInfo(e, "icon")), (e.childNodes[1].nodeValue = getMenuItemInfo(e, "text"))), (e.childNodes[0].nodeValue = getMenuItemInfo(e, "text")))
                      : "LNK" == menuItemType && (e.childNodes[1].childNodes[0].nodeValue = getMenuItemInfo(e, "text"));
              }));
    }
    !mobileDevice &&
        slidingMenu &&
        (((pmbHolder = document.createElement("button")).className = "v-btn v-btn--top v-btn--depressed v-btn--fab v-btn--fixed v-btn--left v-btn--round theme--dark v-size--small primary mad-pmb"),
        ...
        ((mbHolder = document.createElement("button")).className = "v-btn v-btn--top v-btn--depressed v-btn--fab v-btn--fixed v-btn--left v-btn--round theme--dark v-size--small primary mb"),
        ...
        e.parentNode.insertBefore(mbHolder, e),
        (mb = mbHolder.querySelector("i")),
        mbHolder.addEventListener("mouseenter", menuOpen),
        addListeners(e, "mouseenter mouseleave mouseover", navEvent),
        ...
        (menuOpening = !1),
        (menuOpened = !0),
        pinMenu ? (pmb.classList.add(icon_pinOff), menuOpen(), e.classList.add("mad-nav-visible")) : pmb.classList.add(icon_pinOn));
}
function customizeMainContent(e) {
    if (
        ((breadcrumbs = e.querySelector("header")),
        removeBreadcrumbs && !breadcrumbsHidden && breadcrumbs && (breadcrumbs.nextSibling && breadcrumbs.nextSibling.remove(), breadcrumbs.remove(), (breadcrumbsHidden = !0)),
        (sideColumn = e.querySelector("div.flex.page-col-sd.lg3.xl2")))
    )
    ...
    mobileDevice ||
        ((pageTitle = e.querySelector("div.is-page-header")),
        pinMenu
            ? e.style.setProperty("padding-left", "256px", "important")
            : (breadcrumbs && breadcrumbs.querySelector("div").style.setProperty("padding-left", "56px", "important"),
              pageTitle && breadcrumbsHidden && pageTitle.style.setProperty("padding-left", "56px", "important"),
              sideColumn && (sideColumn.style["padding-left"] = "16px"),
              e.style.setProperty("padding-left", "0px", "important")));
    var o = e.querySelectorAll("div.v-card.v-sheet");
    Array.from(o).forEach((e) => {
        removeTocCard && e.querySelector("div[role=list]") && (e.remove(), (removeTocCard = !1)),
            removeTagCard && e.innerHTML.includes("mdi-tag") && (e.remove(), (removeTagCard = !1)),
            removeBookmarkCard && e.innerHTML.includes("mdi-bookmark") && (e.remove(), (removeBookmarkCard = !1)),
            removeHistoryCard && (e.innerHTML.includes("mdi-history") || (e.innerHTML.includes("caption") && !e.innerHTML.includes('role="listitem"') && !e.innerHTML.includes("mdi-tag"))) && (e.remove(), (removeHistoryCard = !1));
    });
    ...
    Array.from(i).forEach((e) => {
        ...
        faccordion(),
        customizeVideoPlayer && setupVideoElements();
}
...
function sectionContainsActivePage(e) {
    ...
    if (Array.isArray(e)) {
        if (
            (t = Array.prototype.filter.call(e, function (e) {
        ...
        if (!sectionContainsActivePage(e)) {
            ...
            e.parentNode.querySelectorAll("." + CM_SECTION + "." + CM_SECTION_EXPANDED).forEach(function (n) {
                ...
                n == e ||
                    sectionContainsActivePage(n) ||
                    o.href == curPathAbs ||
                    (n.classList[fnmap[t]](CM_SECTION_EXPANDED), n.previousElementSibling.classList[fnmap[t]](CM_COLLAPSIBLE_ACTIVE), n.previousElementSibling.classList[fnmap[t]](CM_COLLAPSIBLE_INACTIVE));
            }),
                e.classList[fnmap[t]](CM_SECTION_EXPANDED),
                e.previousElementSibling.classList[fnmap[t]](CM_COLLAPSIBLE_ACTIVE),
                e.previousElementSibling.classList[fnmap[t]](CM_COLLAPSIBLE_INACTIVE);
        }
    };
...
function navEvent() {
    "mouseenter" === event.type ? (isMouseOverNav = !0) : "mouseleave" === event.type ? (isMouseOverNav = !1) : "mouseover" === event.type && (isMouseOverNav = !0),
        mbHolder.contains(event.relatedTarget) || pmbHolder.contains(event.relatedTarget) || ("mouseenter" === event.type && pmbShow(), "mouseleave" === event.type && (pinMenu ? pmbHide() : menuClose()));
}
function pmbEvent() {
...
function toggleMenuPin() {
    document.activeElement && document.activeElement.blur(),
        ...
        pinMenu
            ? (menuOpen(),
              breadcrumbs && breadcrumbs.querySelector("div").style.removeProperty("padding-left"),
              pageTitle && breadcrumbsHidden && pageTitle.style.removeProperty("padding-left"),
              pmb.classList.remove(icon_pinOn),
              pmb.classList.add(icon_pinOff),
              main.style.setProperty("padding-left", "256px", "important"),
              (main.style["transition-timing-function"] = "ease-in"),
              (main.style.transition = "0.5s padding ease-out"),
              btnToTop && "235px" != btnToTop.style.left && (btnToTop.style.left = "235px"),
              btnToTopVisible && animateRtt("show"))
            : (breadcrumbs && breadcrumbs.querySelector("div").style.setProperty("padding-left", "56px", "important"),
              pageTitle && breadcrumbsHidden && pageTitle.style.setProperty("padding-left", "56px", "important"),
              animateRtt("hide"),
              ...
              (main.style["transition-timing-function"] = "ease-out"),
              (main.style.transition = "0.5s padding ease-out"));
}
...
function handleMouseMove(e) {
    ...
    null == (e = e || window.event).pageX &&
        null != e.clientX &&
        ((n = (t = (e.target && e.target.ownerDocument) || document).documentElement),
        (o = t.body),
        (e.pageX = e.clientX + ((n && n.scrollLeft) || (o && o.scrollLeft) || 0) - ((n && n.clientLeft) || (o && o.clientLeft) || 0)),
        (e.pageY = e.clientY + ((n && n.scrollTop) || (o && o.scrollTop) || 0) - ((n && n.clientTop) || (o && o.clientTop) || 0)));
    var i = leftEdge || 2;
    navigation &&
        (e.pageX < i && !pinMenu && mouseLeftEdgeOpensMenu && !menuClosing && !menuOpening && !menuOpened && menuOpen(),
        menuFirstHover && ((menuFirstHover = !1), (isMouseOverNav = isDescendant(navigation, document.elementFromPoint(e.pageX, e.pageY)))));
}
        ...
        document.querySelectorAll("div.mad-wjsc-video").forEach((e) => {
            ...
            t.addEventListener
                ...
                t.addEventListener
                    ...
                    : t.attachEvent("onselectstart", function () {
                          window.event.returnValue = !1;
                      }),
                t.addEventListener
                    ? t.addEventListener(
                    ...
                    : t.attachEvent("ondragstart", function () {
                          window.event.returnValue = !1;
                      }),
                (t.controlsList = "nodownload noremoteplayback"),
                (t.controls = !0);
        });
    },
    ...
    faccordion = function () {
        function e(e, t, n, o) {
            ...
            window.requestAnimationFrame(function r(b) {
                ...
                var g = b - i;
                o
                    ? ((e.style.height = m * g + "px"), (e.style.paddingTop = u * g + "px"), (e.style.paddingBottom = p * g + "px"), (e.style.marginTop = f * g + "px"), (e.style.marginBottom = v * g + "px"))
                    : ((e.style.height = a - m * g + "px"), (e.style.paddingTop = s - u * g + "px"), (e.style.paddingBottom = l - p * g + "px"), (e.style.marginTop = d - f * g + "px"), (e.style.marginBottom = c - v * g + "px")),
                    g >= t
                        ? ((e.style.height = ""),
                          (e.style.paddingTop = ""),
        ...
        document.querySelectorAll("div.faccordion").forEach((e) => {
            e.querySelectorAll("h1,h2,h3,h4,h5,h6").forEach((e) => {
                ...
                e.querySelector("ul") && e.querySelector("ul").classList.add("faccordion"),
                e.querySelectorAll("ul ul").forEach((e) => {
            ...
            document.querySelectorAll(".toggle").forEach((e) => {
                e.onclick = function (r) {
                    if (
                        ...
                        i(e);
                        let r = t(e, ":not(div)");
                        r[0] && r[0].classList.contains("show")
                            ? (o(r[0]),
                              e.parentNode.querySelectorAll(".toggle.show.expanded").forEach((e) => {
                                  let o = t(e, ":not(div)");
